...
export default function Home() {
  return (
    <div className="min-h-screen bg-teal-950 text-white overflow-hidden relative flex items-center justify-center">
      <motion.div
      ...
      <div className="relative z-10 text-center p-8 max-w-4xl mx-auto">
        ...
        >
          Dive into a world where creativity meets technology. Explore my projects and the digital wonders I've crafted.
        </motion.p>
        <motion.div 
