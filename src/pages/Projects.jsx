...
const projects = [
  {
    name: "FlipCraft",
    description: "A platform for repurposing content using AI, set to be released on Monday, 30th August, 2025.",
    link: "#",
                      ...
                      <motion.a
                        ...
                        onClick={(e) => {
                          if (project.showReleaseMessage) {
                            e.preventDefault();
                            alert("To be released on 30th August, 2025. Stay tuned!");
                          }
                        }}
                      >
